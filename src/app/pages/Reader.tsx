...
import { ArrowLeft, Settings, ZoomIn, ZoomOut } from 'lucide-react';
...
export function Reader() {
  ...
  const fontFamilyStyle = settings.fontFamily === 'OpenDyslexic' 
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-gray-600 font-semibold">{settings.fontSize}px</span>
        ...
        {showQuickSettings && (
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Quick Settings</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-700 font-semibold">Reading Ruler</span>
                </label>
              </div>
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 text-blue-600 rounded"
                  />
                  <span className="text-gray-700 font-semibold">Syllable Splitter</span>
                </label>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <div className="text-sm text-gray-600 text-center">{settings.lineSpacing.toFixed(1)}</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">{document.category} • {document.uploadDate}</p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-blue-800">
            ...
            <li>• Complex words are automatically split into syllables for easier reading</li>
