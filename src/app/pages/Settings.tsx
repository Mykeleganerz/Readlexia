...
import { Settings as SettingsIcon, Type, Palette, Ruler, RotateCcw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Accessibility Settings</h1>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  <div className="font-bold text-gray-800 mb-1">OpenDyslexic</div>
                  <div className="text-sm text-gray-600">Specially designed for dyslexia</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">Standard sans-serif font</div>
                </button>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-sm text-gray-600">Standard white background</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-gray-600">Reduces eye strain in low light</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-gray-600">Warm, comfortable reading</div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg">
              <div>
                <div className="font-bold text-gray-800 mb-1">Reading Ruler</div>
                <div className="text-sm text-gray-600">Highlights the line under your cursor</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={settings.readingRulerEnabled}
                  onChange={(e) => updateSettings({ readingRulerEnabled: e.target.checked })}
              ...
              <div className="ml-4 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSettings({ rulerHeight: parseInt(e.target.value) })}
                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg">
              <div>
                <div className="font-bold text-gray-800 mb-1">Syllable Splitter</div>
                <div className="text-sm text-gray-600">Breaks complex words into syllables</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={settings.syllableSplitterEnabled}
                  onChange={(e) => updateSettings({ syllableSplitterEnabled: e.target.checked })}
                  className="sr-only peer"
                />
                <div className="w-14 h-7 bg-gray-300 peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
              </label>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <h3 className="text-lg font-bold text-blue-900 mb-3">💡 Settings Saved Automatically</h3>
          <p className="text-blue-800">
            All your preferences are saved automatically and will be applied to all your reading sessions. 
            Visit the Reader to see your settings in action!
          </p>
        </div>
      </div>
    </div>
